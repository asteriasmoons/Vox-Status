...
export const serviceGroups: ServiceGroup[] = [
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Asterium", description: "iOS and iPadOS services", status: "operational", uptime: "99.99%" },
      { name: "Seery", description: "iOS and iPadOS services", status: "operational", uptime: "99.99%" }
    ]
  },
  {
